...
export default function Home() {
  ...
  const calculateAge = () => {
    ...
    if (!newErrors.day && (isNaN(d) || d < 1 || d > 31))
      newErrors.day = "Must be 1-31";
    if (!newErrors.month && (isNaN(m) || m < 1 || m > 12))
      newErrors.month = "Must be 1-12";
      ...
      <div className="bg-white p-8 rounded-2xl rounded-br-[100px] shadow-lg w-full max-w-xl">
        ...
        <div className="flex flex-row gap-4 mb-6">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className={`border rounded-md p-3 w-24 text-lg font-bold focus:outline-none text-gray-600 placeholder:text-gray-100 ${
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            {errors.month && (
              <span className="text-xs text-red-600">{errors.month}</span>
            )}
          </div>
          <div className="flex flex-col gap-2">
            <label
        ...
        <div className="relative flex items-center mb-6">
          ...
          <button
            ...
            className="absolute right-0 bg-purple-600 hover:bg-purple-700 transition-colors rounded-full w-12 h-12 grid place-items-center text-white">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
